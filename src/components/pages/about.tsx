...
import AbtImg from "@/assets/images/new/abt.webp";
                ...
                <div className="pt-20 md:pt-28 mb-32">
                    <div className="px-5 md:px-0 md:w-[60%] mx-auto">
                        ...
                        <div className="w-full">
                            <Image src={AbtImg} alt="About NovaTradar" className="h-[16rem] md:h-[30rem] w-full object-fit object-cover rounded-lg" />
                        </div>
