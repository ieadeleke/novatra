                    ...
                    </div>
                    {
                        language === "en" ?
                            <div className="px-5 md:px-20 mb-20 pt-20">
                                ...
                                <p className="text-sm md:text-base leading-loose md:leading-loose">
                                    <strong>Email:</strong> <a className="text-sm opacity-80" href="mailTo:help@novatradar.com" target="_blank">help@novatradar.com</a>
                                </p>
                                <p className="text-sm md:text-base leading-loose md:leading-loose">
                                    <strong>Phone:</strong> <a className="text-sm opacity-80" href="mailTo:+380936018625" target="_blank">(+380) 936 01 8625</a>
                                </p>
                                <p className="text-sm md:text-base leading-loose md:leading-loose">
                        ...
                        <ul>
                            ...
                            <li className="text-sm md:text-base leading-loose md:leading-loose">
                                <a href="https://www.apple.com/legal/Privacy/en-ww/cookies/" target="_blank" rel="noopener noreferrer">
                                    Safari
                                </a>
                            </li>
                        </ul> */}
                            ...
                            : language === "ru" ?
                                <div className="px-5 md:px-20 mb-20 pt-20">
                                    ...
                                    <p className="text-sm md:text-base leading-loose md:leading-loose">
                                        <strong>Телефон:</strong> <a className="text-sm opacity-80" href="mailTo:+380936018625" target="_blank">(+380) 936 01 8625</a>
                                    </p>
                                    <p className="text-sm md:text-base leading-loose md:leading-loose">
                                ...
                                : language === "fr" ?
                                    <div className="px-5 md:px-20 mb-20 pt-20">
                                        ...
                                        <p className="text-sm md:text-base leading-loose md:leading-loose">
                                            <strong>Téléphone:</strong> <a className="text-sm opacity-80" href="mailTo:+380936018625" target="_blank">(+380) 936 01 8625</a>
                                        </p>
                                        <p className="text-sm md:text-base leading-loose md:leading-loose">
                                    ...
                                    <div className="px-5 md:px-20 mb-20 pt-20">
                                        ...
                                        <p className="text-sm md:text-base leading-loose md:leading-loose">
                                            <strong>البريد الإلكتروني:</strong> <a className="text-sm opacity-80" href="mailTo:help@novatradar.com" target="_blank">help@novatradar.com</a>
                                        </p>
                                        <p className="text-sm md:text-base leading-loose md:leading-loose">
                                            <strong>الهاتف:</strong> <a className="text-sm opacity-80" href="mailTo:+380936018625" target="_blank">(+380) 936 01 8625</a>
                                        </p>
                                        <p className="text-sm md:text-base leading-loose md:leading-loose">
