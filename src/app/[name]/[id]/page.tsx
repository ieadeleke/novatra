                    ...
                    <>
                        <>
                            <div className="pt-40 md:pt-44 mb-32 px-5 md:px-20">
                                    ...
                                    <div>
                                        {
                                            loadingData ?
                                                ...
                                                :
                                                <img src={`${process.env.NEXT_PUBLIC_LIVE_URL}${product?.image}`} alt={(JSON.parse(product?.translation))[language]?.name} className="w-full h-full rounded-lg object-fit object-cover" />
                                        }
                                    </div>
                                    <div>
                                        {
                                ...
                                <div className="mt-20">
                                    <h4 className="text-xl md:text-2xl mb-2">Similar Products</h4>
