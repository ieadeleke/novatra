                ...
                <div className="md:w-full md:absolute text-center text-white md:box-placing">
                  {
                    loadingData ? "" :
                      <>
                        <div>
                          <h4 className="text-center text-2xl md:text-4xl text-white mb-14 pt-20 font-bold">{t.all_products}</h4>
                        </div>
              ...
              <div>
                ...
                <div className="flex flex-col md:grid grid-cols-2 gap-5">
                  <div className="bg-[#EDF6F5] p-5 rounded-lg">
                    <h3 className="text-2xl md:text-4xl mb-16 font-bold">50+</h3>
                    <div className="">
